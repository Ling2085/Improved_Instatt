...
public final class ActivityQrcodeBinding implements ViewBinding {
  ...
  private ActivityQrcodeBinding(@NonNull ConstraintLayout rootView, @NonNull ImageButton iBback,
      @NonNull ImageView ivQRCode, @NonNull ConstraintLayout main, @NonNull TextView textView) {
  ...
  public static ActivityQrcodeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityQrcodeBinding((ConstraintLayout) rootView, iBback, ivQRCode, main,
          textView);
    }
